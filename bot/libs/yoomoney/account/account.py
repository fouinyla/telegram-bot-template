...
from bot.libs.yoomoney.account.balance_details import BalanceDetails
from bot.libs.yoomoney.account.card import Card


class Account:
    def __init__(self, base_url: str = None, token: str = None, method: str = None):
    ...
    def _request(self):
        access_token = self.__private_token
        ...
        response = httpx.request("POST", url, headers=headers)
